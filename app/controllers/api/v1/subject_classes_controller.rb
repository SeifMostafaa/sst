class Api::V1::SubjectClassesController < ApplicationController
  ...
  api :GET, 'api/v1/subject_classes', 'All Classes'
  returns code: 401, desc: 'Unauthorized'
  returns code: 200,
          desc: "All Classes (It's named subject_class instead of class because the name class is already reserved for use within rails itself)" do
